...
func buildPipelineFixtures(deletedAt string) *store.ExportData {
	...
	observations := []store.Observation{
		...
		makeObs(4, "sess-alpha", "project-a", "discovery", "SDD Plugin Learning", "sdd/plugin", "2026-01-01T04:00:00Z"),
		...
		makeObs(12, "sess-gamma", "project-b", "discovery", "Auth JWT Learning", "auth/jwt", "2026-01-03T04:00:00Z"),
